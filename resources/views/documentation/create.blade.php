...
<section class="text-gray-700 body-font bg-green-200">
    <div class="container px-8 py-2 mx-auto lg:px-4">
        <div class="flex flex-col w-full mb-2 text-left lg:text-center">
            ...
            <form method="post" enctype="multipart/form-data" action="/documentations">
                ...
                <div class="w-full p-2">
                <textarea id="my-editor" name="article"
                          class="w-full px-4 py-2 mr-4 text-base text-blue-700 bg-gray-100 border-transparent rounded-lg
